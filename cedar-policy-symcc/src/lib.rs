...
impl<S: Solver> CedarSymCompiler<S> {
    ...
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_never_errors_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicy` across many
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_always_matches_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicy` across many
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_never_matches_with_counterexample_opt()` instead")]
    ...
    #[deprecated(since = "0.3.0", note = "use `check_matches_equivalent_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicy` across many queries.
    #[deprecated(since = "0.3.0", note = "use `check_matches_implies_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicy` across many queries.
    #[deprecated(since = "0.3.0", note = "use `check_matches_disjoint_with_counterexample_opt()` instead")]
    ...
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_implies_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicies` across many
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_always_allows_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicies` across many
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_always_denies_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicies` across many
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_equivalent_with_counterexample_opt()` instead")]
    ...
    /// instead, which will allow you to reuse a `CompiledPolicies` across many
    /// queries.
    #[deprecated(since = "0.3.0", note = "use `check_disjoint_with_counterexample_opt()` instead")]
