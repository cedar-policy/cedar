...
impl Node<Option<cst::Policy>> {
    ...
    pub fn to_policy(
        ...
        //
        // We want to add [`ToASTError::ExpectedStaticPolicy`] in two cases:
        ...
        // `SlotsInConditionClause`, we can report that as `ExpectedStaticPolicy`
        let new_errs = errs
            .iter()
        ...
        // report that as `ExpectedStaticPolicy`
        match policy {
