...
use cedar_policy_cli::{
    authorize, check_parse, evaluate, partial_evaluate, format_policies, link, new, translate_schema, validate,
...
fn main() -> CedarExitCode {
    ...
    match cli.command {
        ...
        Commands::PartialEvaluate(args) => partial_evaluate(&args).0,
