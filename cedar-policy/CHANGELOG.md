...
- Added unknown_*_with_type methods to the RequestBuilder in partial-eval, allowing an unknown pricipal, resource or action to be constrained to a certain entity type.
