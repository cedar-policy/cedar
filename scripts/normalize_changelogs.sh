...
CEDAR_POLICY_SYMCC_CHANGELOG="cedar-policy-symcc/CHANGELOG.md"
...
STATIC_CEDAR_POLICY_SYMCC_CHANGELOG="scripts/static_changelogs/cedar-policy-symcc_CHANGELOG.md"

if [ -f "$CEDAR_POLICY_CHANGELOG" ] && [ -f "$CEDAR_POLICY_CLI_CHANGELOG" ] && [ -f "$CEDAR_WASM_CHANGELOG" ] && [ -f "$CEDAR_POLICY_SYMCC_CHANGELOG" ]; then
    ...
    cp $STATIC_CEDAR_POLICY_SYMCC_CHANGELOG $CEDAR_POLICY_SYMCC_CHANGELOG
