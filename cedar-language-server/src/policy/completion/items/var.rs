...
use tower_lsp_server::ls_types::{self, Documentation, MarkupContent};
...
impl From<PrincipalCompletionItem<'_>> for tower_lsp_server::ls_types::CompletionItem {
    fn from(value: PrincipalCompletionItem<'_>) -> Self {
        ...
        Self {
            label,
            kind: tower_lsp_server::ls_types::CompletionItemKind::VARIABLE.into(),
...
impl From<ActionCompletionItem<'_>> for tower_lsp_server::ls_types::CompletionItem {
...
impl From<ResourceCompletionItem<'_>> for tower_lsp_server::ls_types::CompletionItem {
    fn from(value: ResourceCompletionItem<'_>) -> Self {
        let label = if value.template {
            "?resource"
        } else {
...
impl From<ContextCompletionIem<'_>> for tower_lsp_server::ls_types::CompletionItem {
    fn from(value: ContextCompletionIem<'_>) -> Self {
        Self {
...
impl From<BoolCompletionItem> for tower_lsp_server::ls_types::CompletionItem {
    fn from(value: BoolCompletionItem) -> Self {
        Self {
            ...
            kind: Some(ls_types::CompletionItemKind::CONSTANT),
            ..Self::default()
        }
    }
}
